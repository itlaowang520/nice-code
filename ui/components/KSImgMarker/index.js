...
const MarkPaper = (props) => {
    ...
    useEffect(() => {
        ...
        setFillImageSrc(`${props.imgUrl}?x-oss-process=image/rotate,${rotate}`);
    }, []);
    ...
    const handleMouseModeChange = (value) => {
        ...
        if( value===ROTATE ){//旋转
            const tempRotate = (rotate + 90) % 360;
            setRotate(tempRotate);
            setFillImageSrc(`${props.imgUrl}?x-oss-process=image/rotate,${tempRotate}`);
        }
        switch (value) {
            case MOVE_MODE:
                ...
                <div className="mark-paper-sider">
                    ...
                    <div className="color-picker">
                        ...
                        <div className="color-picker-container">
                            {['#fa4b2a', 'green', '#ffff00', '#ee00ee', '#1890ff', '#333333', '#ffffff'].map((color) => {
                                return (
