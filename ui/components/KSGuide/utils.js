...
export function mask(params, config) {
    ...
    console.log(config, 'config', scrollWidth, 'scrollWidth', offsetWidth, 'offsetWidth', offsetLeft, 'offsetLeft');
    ...
    if (config) {
        tipEle.style.left = `${scrollWidth - 180}px`;
        tipEle.style.top = config.topSting;
    }
    /** **************   为Mask设置desc   ****************/
